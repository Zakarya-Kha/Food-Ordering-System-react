...
function About() {
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row py-20 justify-center gap-10'>
        ...
        <div className='w-full md:w-[45%] flex justify-center'>
          <img className='rounded-lg w-full md:w-[400px] object-cover' src="https://b.zmtcdn.com/web/about/a7b0a36d5107f3590895981dab2eeac31563208212.jpeg?output-format=webp" alt="" />
        </div>
      </div>
    </div>
  );
